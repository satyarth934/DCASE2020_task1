...
def main():
    ...
    output_path = '../../data/features/logmel128_scaled_singlechannel_sr8000_10secs'
    feature_type = 'logmel'
    ...
    print()
    print(f"Total time for sr{sr}, channels{num_channel}, {duration} seconds:\n{(total_time/len(wavpath))}")
    print()
